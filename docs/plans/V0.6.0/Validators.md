...
Key generation, storage, and loading are documented in [Cryptography](plans/V0.6.0/Cryptography.md#Key-Storage).

## Rewards

Fee income is distributed **pro-rata by stake** across all active validators at the end of every block — **not** kept by the proposer. See [Fees](plans/V0.6.0/Fees.md) for the full distribution mechanics.
...
- Block rewards defined by `CappedInflation` policy (see [Genesis](plans/V0.6.0/Genesis.md#Token-Supply))
...
| Tier                                         | Purpose                 |
| -------------------------------------------- | ----------------------- |
| [Localnet](plans/V0.6.0/Network.md#Localnet) | Single-node development |
| [Devnet](plans/V0.6.0/Network.md#Devnet)     | Multi-validator testing |
| [Testnet](plans/V0.6.0/Network.md#Testnet)   | Public test network     |
| [Mainnet](plans/V0.6.0/Network.md#Mainnet)   | Production              |

---

**Related:** [Consensus](plans/V0.6.0/Consensus.md), [Network](plans/V0.6.0/Network.md), [Slashing](plans/V0.6.0/Slashing.md), [Cryptography](plans/V0.6.0/Cryptography.md)
