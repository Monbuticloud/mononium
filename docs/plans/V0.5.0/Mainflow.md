...
| 👥 Validators   | [Validators](plans/V0.5.0/Validators.md)     | Cheap VPS target, PoS, validator lifecycle       |
| ⚡ Consensus    | [Consensus](plans/V0.5.0/Consensus.md)       | PoS, 5s block, 20s finality, BFT commit          |
| 🗄️ Mempool      | [Mempool](plans/V0.5.0/Mempool.md)           | Tip → Time → Nonce, nonce buffering, rate limit  |
| 💾 Storage      | [Storage](plans/V0.5.0/Storage.md)           | redb, mutable + append-only, checkpoints         |
| 📋 Protocol     | [Protocol](plans/V0.5.0/Protocol.md)         | Account model, Falcon-512 sigs, native tx first  |
| 💰 Fees         | [Fees](plans/V0.5.0/Fees.md)                 | Hybrid fee, anti-spam deposit, pro-rata distro   |
| 🌱 Genesis      | [Genesis](plans/V0.5.0/Genesis.md)           | JSON format, capped inflation, fair launch       |
...
| ⚖️ Slashing     | [Slashing](plans/V0.5.0/Slashing.md)         | 90% equivocation penalty, evidence format        |
