...
Fees, fee distribution, and anti-spam deposits are documented in [Fees](plans/V0.5.0/Fees.md).

Genesis format, loading, and token supply are documented in [Genesis](plans/V0.5.0/Genesis.md).
...
**Related:** [Architecture](plans/V0.5.0/Architecture.md), [Consensus](plans/V0.5.0/Consensus.md), [Network](plans/V0.5.0/Network.md), [Fees](plans/V0.5.0/Fees.md), [Genesis](plans/V0.5.0/Genesis.md)
