...
| `2`   | Frozen | Slashed — excluded from active set for 72 eras (see [Slashing](plans/V0.7.0/Slashing.md#freeze-period)) |
...
Fees, fee distribution, and anti-spam deposits are documented in [Fees](plans/V0.7.0/Fees.md).

Genesis format, loading, and token supply are documented in [Genesis](plans/V0.7.0/Genesis.md).
