...
- The Cap-Refill address (`0x00..01`) is unrelated to slashing; see [Supply](../plans/V0.4.0/Protocol.md#Token-Supply)
...
| Tier                                         | Purpose                 |
| -------------------------------------------- | ----------------------- |
| [Localnet](plans/V0.4.0/Network.md#Localnet) | Single-node development |
| [Devnet](plans/V0.4.0/Network.md#Devnet)     | Multi-validator testing |
| [Testnet](plans/V0.4.0/Network.md#Testnet)   | Public test network     |
| [Mainnet](plans/V0.4.0/Network.md#Mainnet)   | Production              |

---

**Related:** [Consensus](plans/V0.4.0/Consensus.md), [Network](plans/V0.4.0/Network.md)
