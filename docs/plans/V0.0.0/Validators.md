...
| Tier                           | Purpose                 |
| ------------------------------ | ----------------------- |
| [[Network#Localnet\|Localnet]] | Single-node development |
| [[Network#Devnet\|Devnet]]     | Multi-validator testing |
| [[Network#Testnet\|Testnet]]   | Public test network     |
| [[Network#Mainnet\|Mainnet]]   | Production              |

---

**Related:** [[Consensus]], [[Network]]
